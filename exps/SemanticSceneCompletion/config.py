...
C.root_dir = '/mnt/lustre/liushinan/cyj/start'
...
C.h_root_folder = osp.join(C.dataset_path, 'H')
C.m_root_folder = osp.join(C.dataset_path, 'M')
...
C.bn_eps = 1e-5
C.bn_momentum = 0.1
#C.pretrained_model = C.volna + 'DATA/.torch/pytorch-weight/resnet50-imagenet.pth'
